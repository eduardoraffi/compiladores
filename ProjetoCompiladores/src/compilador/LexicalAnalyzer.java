...
public class LexicalAnalyzer 
{
    ...
    private void readAllFile() throws Exception {
    	...
    	while(leituraDoArquivo != -1)
    	{
    		...
    		//Trata conteudo dentro de comentario do tipo /**/ para que n�o entre na tabela de tokens
    		...
    		if(mToken == null)
    		{
    			throw new Exception("Invalid token at line " + line);
    		}
    ...
    public Token pegaToken() throws Exception
    {
        ...
        if(caracterLido == Constants.C_MAIS || caracterLido == Constants.C_MENOS || caracterLido == Constants.C_ESTRELA)
        {
